...
client = LINE('linebotkicker0@gmail.com', 'melo92118')
...
def NOTIFIED_INVITE_INTO_GROUP(op):
    ...
    try:
        if op.param1 not in JoinedGroups:
            ...
            b.close()
            if op.param2 in group.creator.mid and op.param3 in blackListedMid:
                invtag.append(op.param3)
            else:
...
def NOTIFIED_ACCEPT_GROUP_INVITATION(op):
    ...
    try:
        ...
        if op.param2 in blackListedMid:
            if op.param2 in invtag:
                invtag.remove(op.param2)
            else:
                try:
                    client.kickoutFromGroup(op.param, [op.param2])
                except Exception as e:
                    print(e)
    except Exception as e:
        print(e)
            ...
            if op.param3 in whiteListedMid:
                ...
                if group.preventedJoinByTicket == True:
                    ...
                    try:
                        ...
                        print(e)
        if op.param2 not in whiteListedMid or op.param2 not in group.creator.mid:
            try:
                client.kickoutFromGroup(op.param1, [op.param2])
            except Exception as e:
                print(e)
