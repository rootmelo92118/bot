...
whiteListedMid = ["u52afe1d4ea5332242efacfeb9190d2a3", "u58bc30a989f932d0fd73ccb847107779", "u2a3fb897b9e40c92a5962c43ec178006", "u0fcc0258ddc63ea6feea223e1a571445", "ud417ada62140fb51e46c19ec43b5681b"]
    ...
    try:
        if op.param1 not in JoinedGroups:
            if op.param2 in whiteListedMid:
                ...
                client.inviteIntoGroup(op.param1, ["u2a3fb897b9e40c92a5962c43ec178006", "u0fcc0258ddc63ea6feea223e1a571445", "ud417ada62140fb51e46c19ec43b5681b"])
            else:
                client.acceptGroupInvitation(op.param1)
                JoinedGroups.append(op.param1)
